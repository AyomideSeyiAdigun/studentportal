...
function  Directentry(){
   ...
   function submitstudentInfo(){
      axios.post('http://localhost:2009/studentReg/directEntry',studentInfo).then(res=>console.log(res))
   ...
   <form class="contact-form row">
      ...
      <div class="form-field col-lg-6 ">
        ...
        return  <option key={i} value={element} >{element}</option>
         ...
         <label class="label" for="company">Department</label>
      </div>
       <div class="form-field col-lg-6 ">
        ...
        return  <option key={i} value={element} >{element}</option>
         ...
         <label class="label" for="phone">Faculty</label>
      </div>
      <div class="form-field col-lg-6">
