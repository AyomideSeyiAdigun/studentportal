...
function Hundredlevel(){
    ...
    function handleEvent(event,type){
        if (type==='name') {
            ...
            console.log(courseInfo.courseDept)
        }
     ...
     function submithundredlevel(){
       console.log(courseInfo)
        axios.post('http://localhost:2009/courseReg/100',courseInfo).then(res=>console.log(res.body))
  ...
  <button class="btn btn-primary" type="submit" onClick={submithundredlevel}>Submit form</button>
</form>
