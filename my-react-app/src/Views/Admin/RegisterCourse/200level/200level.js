...
function Twohundredlevel(){
  ...
  function handleEvent(event,type){
   ...
   function submittwohundredlevel(){
      axios.post('http://localhost:2009/courseReg/200',courseInfo).then(res=>console.log(res))
...
<button class="btn btn-primary" type="submit" onClick={submittwohundredlevel}>Submit form</button>
</form>
...
export default Twohundredlevel