...
function Threehundredlevel(){
  ...
  function handleEvent(event,type){
   ...
   function submitthreehundredlevel(){
      axios.post('http://localhost:2009/courseReg/300',courseInfo).then(res=>console.log(res))
...
<button class="btn btn-primary" type="submit" onClick={submitthreehundredlevel}>Submit form</button>
</form>
