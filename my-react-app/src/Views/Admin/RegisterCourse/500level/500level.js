import css from "./500level.css";

import { useState ,useEffect} from "react";
import axios from 'axios'

function Fivehundredlevel(){
  ...
  function handleEvent(event,type){
   ...
   function submitfivehundredlevel(){
      axios.post('http://localhost:2009/courseReg/500',courseInfo).then(res=>console.log(res))
...
<button class="btn btn-primary" type="submit" onClick={submitfivehundredlevel}>Submit form</button>
</form>
...
export default Fivehundredlevel