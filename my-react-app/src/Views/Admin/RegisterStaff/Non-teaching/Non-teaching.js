...
function Nonteaching(){
  const [staffInfo, setstaffinfo] = useState({staffName:'',staffPosition:'',staffLevel:'',staffEmail:'',Stafffaculty:''})
 ...
 useEffect( () => {
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault03"  onChange={e=>handleEvent(e,'level')} required/>
    </div>
    <div class="col-md-6 mb-3">
  ...
  <button class="btn btn-primary"  type="submit"  onClick={submitnonteaching}>Submit form</button>
</form>
                </div>
            </div>
        </div>
